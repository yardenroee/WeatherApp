            ...
            <Paper className={classes.root}>
                ...
                <div className={classes.flex}>
                    <div className={classes.weatherWindow}>
                        ...
                        >
                            <BottomNavigationAction label="Github" onClick={() => window.open("someLink", "_blank")} icon={<svg style={{ width: 32, height: 32 }} viewBox="0 0 24 24">
                            ...
                            <BottomNavigationAction label="LinkedIn" icon={<svg style={{ width: 32, height: 32 }} viewBox="0 0 24 24">
                            ...
                            <BottomNavigationAction label="Portfolio" icon={<svg style={{ width: 32, height: 32 }} viewBox="0 0 24 24">
